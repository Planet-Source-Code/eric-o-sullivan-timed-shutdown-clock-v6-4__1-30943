Attribute VB_Name = "RegistryOwner"
'This module reads the registry to find out the registered
...
'This constant determins whether or not to display error messages to the
...
Public Function GetOwnerInReg() As String
' Get users name from the registry
GetOwnerInReg = GetStringValue("HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion", "RegisteredOwner")
End Function

Public Function GetCompanyInReg() As String
' Get the company from the registry
GetCompanyInReg = GetStringValue("HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion", "RegisteredOrganization")
End Function
